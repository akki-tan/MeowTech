    ...
    <div class="flex items-center justify-center min-h-screen bg-pink-100">
        <form action="/simpan" method="POST"
            ...
            <div class="mb-4">
                ...
                <input type="name" name="name"class="w-full px-4 py-2 border-2 border-untukhoverar rounded-lg focus:outline-none focus:border-untukbg" placeholder="Masukkan Nama" />
            </div>
            <div class="mb-4">
                <label for="email" class="block text-untukbg font-medium mb-2">Email</label>
                <input type="email" name="email" class="w-full px-4 py-2 border-2 border-untukhoverar rounded-lg focus:outline-none focus:border-untukbg" placeholder="Masukkan email" />
            </div>
            <div class="mb-6">
                <label for="password" class="block text-untukbg font-medium mb-2">Password</label>
                <input type="password" name="password" class="w-full px-4 py-2 border-2 border-untukhoverar rounded-lg focus:outline-none focus:border-untukbg" placeholder="Masukkan password" />
            </div>
            <div class="mb-6">
                <label for="kota" class="block text-untukbg font-medium mb-2">Asal Kota</label>
                <input type="kota" name="kota" class="w-full px-4 py-2 border-2 border-untukhoverar rounded-lg focus:outline-none focus:border-untukbg" placeholder="Masukkan Asal Kota" />
            </div>
            <button type="submit"
