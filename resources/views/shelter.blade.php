<x-layout>
    ...
    <section class="max-w-6xl mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white border border-untukhoverar rounded-2xl p-5 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all">
                ...
                <button class="mt-4 w-full rounded-xl px-4 py-2 border border-untukhoverar text-untukbg font-medium hover:bg-untukhoverar transition-all">
                    Lihat Detail
                </button>
            </div>
            <div class="bg-white border border-untukhoverar rounded-2xl p-5 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all">
